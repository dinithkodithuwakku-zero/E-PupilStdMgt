...
namespace E_PupilStdMgt.src.entity
{
    class Stuff
    {
        ...
        public Stuff(int stuffId, string userName, string password, string fullName, string nic, string jobTitle, string mobileNo, string email, string permanentAddress)
        {
        ...
        public Stuff(int stuffId, string fullName, string nic, string jobTitle, string mobileNo, string email, string permanentAddress)
        {
            this.stuffId = stuffId;
            this.fullName = fullName;
            this.nic = nic;
